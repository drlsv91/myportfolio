...
import home from '../assets/mortal_combat/home.jpg'
import discover from '../assets/mortal_combat/discover.jpg'
import showcase from '../assets/mortal_combat/showcase.jpg'

const projectData = [{
    id: 6,
    title: 'Mortal Kombat Clone',
    imageUrl: home,
    status: 'project',
    technologies: ['Reactjs', 'Tailwindcss', 'material ui'],
    details: {
      ...
      link: 'https://mortal-combat-clone.herokuapp.com/',
      status: 'development',
      githubUrl: '',
      images: [home, discover, showcase],
    },
  },
  {
    id: 0,
